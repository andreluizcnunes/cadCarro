...
const Formulario = ({ botao, getDadosForm, cadastrar, obj, cancelar, remover, alterar }) => {
    return (
            ...
            
            {
                ...
                :
                    <div className="d-flex gap-3">
                        <input type="button" onClick={alterar} defaultValue='Alterar' className="btn btn-warning col-md-3"/>
